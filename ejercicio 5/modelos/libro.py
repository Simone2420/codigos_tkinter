...
class Libro:
    ...
    def __init__(self, titulo, autor, ano_publicacion,categoria,id=0):
        self._titulo = titulo
        self._autor = autor
    ...
    def establecer_numero_veces_solicitado(self,numero_veces_solicitado):
        self._numero_veces_solicitado = numero_veces_solicitado
